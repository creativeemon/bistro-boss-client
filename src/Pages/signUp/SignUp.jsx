    ...
    const onSubmit = data => {
        ...
        .then(result =>{
            ...
            .then(()=> {
               ...
               fetch('https://bistro-boss-server-xi-plum.vercel.app/users', {
                method: 'POST',
                headers: {
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                {errors.password?.type === 'pattern' && <p className="text-red-600">password must be one aper cas one lower cas and one special character</p>}
                                <label className="label">
